...
map.getView().fit([-8418740.643112, 541141.820040, -8417882.108909, 541683.124937], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">LA ASMALIA LOTES</h2>';
        return titleElement;
    })(),
